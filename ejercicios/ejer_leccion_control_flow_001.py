...
for index, age in enumerate(nominated):
    for winner in nominated[age]:
        if winner in nom_count_dict:
            nom_count_dict[winner] = nom_count_dict[winner] + 1
        else:
            nom_count_dict[winner] = 1
...
win_count_dict = {}
# Add your code here
for index, age in enumerate(winners):
    for winner in winners[age]:
        if winner in win_count_dict:
            win_count_dict[winner] = win_count_dict[winner] + 1
        else:
